<x-layout>
    <main class="font-sans antialiased dark:bg-black dark:text-white/50 pt-2">
        ...
        <div class="bg-blue-900 p-4 rounded-b-xl">
            <div class="text-white flex md:flex-row flex-col justify-between items-center">
                <span class="md:text-6xl text-3xl text-center font-bold md:p-24 p-4">
                    ALL YOUR <br> EXPENSES <br> IN ONE PLACE
                </span>
                <img src="{{ asset('images/image4.png') }}" alt="">
            </div>

            <div class="text-white flex md:flex-row flex-col-reverse justify-between items-center">
        ...
        <div class="mt-2 bg-gray-200 rounded-xl p-8">
            <h3 class="text-gray-400 md:text-2xl text-xl font-md">HOW IT WORKS</h3>
            <div class="flex md:flex-row flex-col justify-between items-center">
                <span class="md:text-7xl text-3xl font-bold">
                    Do it in three easy
                    <br/>steps
                </span>
                <span class="font-md md:text-2xl text-xl">
            ...
            <div class="bg-blue-100 rounded-lg flex flex-col md:flex-row gap-4 p-4 mt-4">
                <div class="relative p-2 rounded-lg border border-blue-200 bg-white md:w-2/6">
                    ...
                    <div class=" flex flex-col gap-2 items-center justify-center p-4">
                        <svg class="w-24 h-24 md:w-48 md:h-48 lg:w-72 lg:h-72" xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 220 220"
                             fill="none">
                        ...
                        <span class="font-bold text-left md:text-3xl text-2xl">Creating your
                            <br/>personal account
                ...
                <div class="relative p-2 rounded-lg border border-blue-200 bg-white md:w-2/6">
                    ...
                    <div class="flex flex-col gap-2 items-center justify-center p-4">
                        <span class="font-bold text-left md:text-3xl text-2xl text-right md:text-left">Creating your
                            <br/>personal account
                            <br/>is easy and free.</span>
                        <svg class="w-24 h-24 md:w-48 md:h-48 lg:w-72 lg:h-72" xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 220 220"
                             fill="none">
        ...
        <div class="mt-8">
            <h3 class="text-gray-400 md:text-2xl text-xl font-md">Testimonials</h3>
            <h2 class="md:text-4xl text-3xl font-bold">What our users say about us</h2>

            <div class="flex flex-col md:flex-row gap-4 p-4 mt-4">
                <div class="relative p-6 rounded-lg border border-blue-200 bg-white md:w-2/6">
